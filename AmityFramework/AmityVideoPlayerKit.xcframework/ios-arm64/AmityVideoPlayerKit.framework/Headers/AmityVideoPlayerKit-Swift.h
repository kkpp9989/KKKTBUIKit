...
#ifndef AMITYVIDEOPLAYERKIT_SWIFT_H
#define AMITYVIDEOPLAYERKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AmityVideoPlayerKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC19AmityVideoPlayerKit13PlayerSession")
@interface PlayerSession : RealmSwiftObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// Class which implements the various <code>URLSessionDelegate</code> methods to connect various Alamofire features.
SWIFT_CLASS("_TtC19AmityVideoPlayerKit15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(AmityVideoPlayerKit)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(AmityVideoPlayerKit)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(AmityVideoPlayerKit)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(AmityVideoPlayerKit)) <NSURLSessionTaskDelegate>
